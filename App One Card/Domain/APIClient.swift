...
class APIClient {
    ...
    static func callAPI2<T: Decodable>(route: Route, method: Method, parameters: [String : Any]? = nil, request: BaseRequest? = nil, showLoading: Bool = false) -> AnyPublisher<T, Error> {
