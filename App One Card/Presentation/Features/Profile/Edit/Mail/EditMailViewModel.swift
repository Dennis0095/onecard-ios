...
class EditMailViewModel: EditMailViewModelProtocol {
    ...
    func successfulEdit() {
        self.successfulRouter.navigateToSuccessfulScreen(title: Constants.congratulations, description: "Has modificado tu correo electrónico con éxito.", button: "Regresar", image: #imageLiteral(resourceName: "congratulations.svg"), accept: {
            self.profileRouter.logout(isManual: false)
        })
    }
}
